...
import { SelectSingle, SelectMulti, SelectSearchSingle, SelectOption } from '@politico/vue-accessible-selects'
...
export default Vue.extend({
	components: { SelectSingle, SelectMulti, SelectSearchSingle },
	data() {
		return {
			sampleOptions,
			selectSingleValue: {} as SelectOption,
			selectSearchSingleValue: {} as SelectOption,
...
<!-- In component -->
<SelectSingle
	v-model:value="selectSingleValue"
...
<SelectMulti
	v-model:values="selectMultiValues"
	:options="sampleOptions"
...
<SelectSearchSingle
	v-model:value="selectSearchSingleValue"
	:options="sampleOptions"
	label="My Search Single Select"
	:labelIsVisible="true"
	placeholder="Default Text to Display"
